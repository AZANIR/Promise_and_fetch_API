...
if (typeof process !== 'undefined') {
    process.on('unhandledRejection', (reason, promise) => {
        ...
        // Не завершуємо процес, щоб продовжити виконання
    });
}

// Приклад необробленої помилки (для демонстрації)
// У реальному коді завжди обробляйте помилки!
Promise.reject(new Error('Необроблена помилка')).catch(() => {
    // Обробка для запобігання unhandledRejection
});
